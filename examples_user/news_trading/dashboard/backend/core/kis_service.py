...
# 기존 모듈 경로 추가
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent))  # examples_user/news_trading
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent.parent))  # examples_user
